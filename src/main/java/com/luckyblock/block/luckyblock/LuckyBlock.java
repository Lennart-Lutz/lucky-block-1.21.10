...
public class LuckyBlock extends Block {
    ...
    public LuckyBlock(Settings settings) {
        ...
        // Probability values for the Lucky Block
        Map<LuckyCategory, Integer> weights = Map.of(
                LuckyCategory.VERY_UNLUCKY, 1,
                LuckyCategory.UNLUCKY, 19,
                LuckyCategory.COMMON, 70,
                LuckyCategory.LUCKY, 8,
                LuckyCategory.VERY_LUCKY, 2
        );
    ...
    public void afterBreak(World world, PlayerEntity player, BlockPos pos,
        ...
        if (tool.isOf(Items.NETHERITE_HOE)) {
            ...
            if (!world.isClient()) {
                ItemStack stack = new ItemStack(ModBlocks.LUCKY_BLOCK);
        ...
        if (!world.isClient() && world instanceof ServerWorld serverWorld) {
            ...
            // Monitor some stats for the player
            if (player != null) {
